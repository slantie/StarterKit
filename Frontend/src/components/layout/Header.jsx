...
function Header() {
  ...
  return (
    <header className="p-4 flex justify-between items-center border-b-2 border-light-muted-text/20 dark:border-dark-muted-text/20">
      <div className="flex items-center justify-center space-x-4">
        <div className="flex items-center">
          <img src="/Logo.png" alt="Logo" className="w-8 h-8" />
        </div>
        <h1 className="text-2xl font-semibold tracking-wide hover:text-light-highlight dark:hover:text-dark-highlight">
          {projectName}
        </h1>
      </div>
          ...
          {isAuthenticated && user ? (
            ...
            <div className="relative user-menu-container">
              ...
              >
                ...
                <div 
                  className={`w-6 h-6 bg-gradient-to-br from-light-highlight to-light-highlight/80 dark:from-dark-highlight dark:to-dark-highlight/80 rounded-full flex items-center justify-center text-white text-sm font-bold ${user.avatar ? 'hidden' : 'flex'}`}
                >
                ...
                <div className="absolute right-0 mt-2 w-64 bg-light-background dark:bg-dark-background border-2 border-light-muted-text/20 dark:border-dark-muted-text/20 rounded-lg shadow-lg z-50 overflow-hidden">
                  ...
                  <div className="px-4 py-3 border-b border-light-muted-text/10 dark:border-dark-muted-text/10 bg-light-muted-background/30 dark:bg-dark-muted-background/30">
                    <div className="flex items-center space-x-3">
                      ...
                      <div 
                        className={`w-10 h-10 bg-gradient-to-br from-light-highlight to-light-highlight/80 dark:from-dark-highlight dark:to-dark-highlight/80 rounded-full flex items-center justify-center text-white font-bold ${user.avatar ? 'hidden' : 'flex'}`}
                      >
                        {user.firstName?.charAt(0)?.toUpperCase() || 'U'}
                      </div>
